...
The world-model release: shipped latent producers, an end-to-end front-to-back
demo, a `retina` CLI, a typed package, and a pre-launch hardening pass.
...
[Unreleased]: https://github.com/machinefi/trio-retina/compare/v0.3.0...HEAD
[0.3.0]: https://github.com/machinefi/trio-retina/releases/tag/v0.3.0
